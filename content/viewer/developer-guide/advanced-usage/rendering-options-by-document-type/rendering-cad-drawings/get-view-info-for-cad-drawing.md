...
# Please get your Client Id and Client Secret from https://dashboard.groupdocs.cloud/applications. Place them in the CLIENT_ID and CLIENT_SECRET environment variables.
...
curl.exe -v "https://api.groupdocs.cloud/v2.0/viewer/info" `
  ...
  -d "{ 'FileInfo': { 'FilePath': 'SampleFiles/with_layers_and_layouts.dwg' } }"
```
{{< /tab >}}
