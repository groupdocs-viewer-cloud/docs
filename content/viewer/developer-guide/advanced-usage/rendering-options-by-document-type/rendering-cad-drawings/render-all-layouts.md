...
```powershell
# First get JSON Web Token
# Ensure environment variables CLIENT_ID, CLIENT_SECRET, and JWT_TOKEN are set.
...
curl -v "https://api.groupdocs.cloud/v2.0/viewer/view" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"FileInfo\":{\"FilePath\":\"SampleFiles/with_layers_and_layouts.dwg\"},\"ViewFormat\":\"HTML\",\"RenderOptions\":{\"CadOptions\":{\"RenderLayouts\":true}}}"
```
{{< /tab >}} {{< tab "Response" >}}
```json
{
